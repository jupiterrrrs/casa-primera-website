    ...
    <section id="location" className="py-20" style={{ background: "#e0f7fa" }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-lg mx-auto" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", color: "#4a5e40", fontSize: "1.05rem", lineHeight: 1.7 }}>
          ...
          <div className="space-y-5">
            <div className="rounded-2xl p-5 shadow-sm" style={{ backgroundColor: "#fff" }}>
              <div className="flex items-start gap-3 mb-1">
                ...
                <div>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.8rem", color: "#9aaa8e", textTransform: "uppercase", letterSpacing: "0.07em" }}>Address</p>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.95rem", color: "#1a2e1a", fontWeight: 500, lineHeight: 1.55 }}>
            ...
            {/* Per-villa map links */}
            <div className="rounded-2xl p-5 shadow-sm" style={{ backgroundColor: "#fff" }}>
              <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.8rem", color: "#9aaa8e", textTransform: "uppercase", letterSpacing: "0.07em" }} className="mb-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                {[
                  ...
                  >
                    <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.85rem", color: "#1a2e1a", fontWeight: 500 }}>{v.label}</span>
                    <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.78rem", color: "#007a9a", fontWeight: 600 }}>View Map →</span>
                  </a>
                ))}
              </div>
            </div>
            ...
            <div className="rounded-2xl p-5 shadow-sm" style={{ backgroundColor: "#fff" }}>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.8rem", color: "#9aaa8e", textTransform: "uppercase", letterSpacing: "0.07em" }}>Hours</p>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.95rem", color: "#1a2e1a", fontWeight: 500 }}>
                    Open Daily · 24/7 for guests
                  </p>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.82rem", color: "#6b7a5e" }}>
            ...
            <div className="rounded-2xl p-5 shadow-sm" style={{ backgroundColor: "#fff" }}>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.8rem", color: "#9aaa8e", textTransform: "uppercase", letterSpacing: "0.07em" }}>Contact</p>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.9rem", color: "#1a2e1a", fontWeight: 500, lineHeight: 1.6 }}>
                    Globe: 0917.114.6956 / 0956.836.6100<br />
                    Smart: 0919.007.8821 / 0960.381.7151<br />
                    Landline: (049) 502-3746
                  </p>
                  <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.82rem", color: "#6b7a5e", marginTop: "0.3rem" }}>sales@casaprimeravilla.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <a
                ...
                style={{ backgroundColor: "#f5c42c", color: "#1a2e1a", fontFamily: "'Plus Jakarta Sans', sans-serif" }}
              >
            ...
            <div className="rounded-2xl p-4" style={{ backgroundColor: "#fff8e1" }}>
              <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.82rem", color: "#7a6000", lineHeight: 1.65 }}>
