    ...
    color: "rgba(255,255,255,0.75)"
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-2.5 mb-1">
            <div className="w-14 h-14 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0 p-1.5" style={{
            backgroundColor: "#fff"
          }}>
              <img src="/images/logo-full.png" alt="Casa Primera Hot Spring Resorts logo" className="w-full h-full object-contain" />
            </div>
            <div>
        ...
        <div>
          ...
          <ul className="space-y-4 mb-6">
            ...
            <li className="flex gap-3 items-center">
              ...
              fontFamily: "'Plus Jakarta Sans', sans-serif",
              fontSize: "0.88rem"
            }}>sales@casaprimeravilla.com</span>
            </li>
          </ul>
        </div>
      </div>

      <div className="border-t px-6 py-5 flex flex-col md:flex-row justify-between items-center gap-3" style={{
      borderColor: "rgba(255,255,255,0.08)"
        ...
        fontSize: "0.8rem"
          ...
          Hot Spring Resorts in Calamba, Laguna · <span style={{
          color: "#45B3C0"
        }}>Relax, Refresh, Reconnect</span>
        </p>
      </div>
    </footer>;
}
