...
function StarRow({
  ...
  return <div className="flex gap-0.5">
      {[1, 2, 3, 4, 5].map(s => <Star key={s} size={13} fill={s <= rating ? "#FFEB3B" : "#e5e7eb"} stroke="none" />)}
    </div>;
}
function ReviewCard({
  review,
  ...
  return <div className="rounded-2xl p-5 shadow-sm h-full flex flex-col" style={{
    backgroundColor: "#fff",
    border: "1px solid rgba(69,179,192,0.12)"
  }}>
      <div className="flex items-start gap-3 mb-3">
        <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold text-sm" style={{
        backgroundColor: source === "google" ? "#45B3C0" : "#1877f2"
      }}>
          {review.avatar}
        </div>
        ...
        <span className="flex-shrink-0 px-2 py-0.5 rounded-full text-xs font-bold" style={{
      ...
      <button onClick={() => setLiked(l => !l)} className="flex items-center gap-1.5 mt-3 transition-colors duration-200" style={{
      color: liked ? "#45B3C0" : "#999999",
      fontFamily: "'Plus Jakarta Sans', sans-serif",
      fontSize: "0.78rem"
    }}>
...
export function ReviewsSection() {
  ...
  return <section id="reviews" className="py-20" style={{
    background: "#EAF7F8"
  }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          fontWeight: 700
            ...
            What Our Guests <span style={{
            color: "#45B3C0"
          }}>Say</span>
          </h2>
          <p className="mt-3 max-w-lg mx-auto" style={{
          fontFamily: "'Plus Jakarta Sans', sans-serif",
          color: "#666666",
          fontSize: "0.95rem"
        }}>
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-8 mb-6">
            <div className="px-7 py-4 rounded-2xl shadow-sm" style={{
            backgroundColor: "#fff",
            border: "1px solid #DCF1F3"
              ...
              fontSize: "0.72rem",
              color: "#999999"
            }}>{stats.google.count} verified reviews</p>
            </div>
            <div className="px-7 py-4 rounded-2xl shadow-sm" style={{
            backgroundColor: "#fff",
            border: "1px solid #e7f0fd"
              ...
              fontSize: "0.72rem",
              color: "#999999"
            }}>{stats.fb.count} likes · {stats.checkins} check-ins</p>
            </div>
            <div className="px-7 py-4 rounded-2xl shadow-sm" style={{
            backgroundColor: "#fff",
            border: "1px solid #DCF1F3"
              ...
              fontSize: "0.8rem",
              color: "#666666"
            }}>Est. Pansol Pioneer</p>
              <p style={{
              fontFamily: "'Plus Jakarta Sans', sans-serif",
              fontSize: "0.72rem",
              color: "#999999"
            }}>15+ years trusted resort</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center mb-8">
          ...
          backgroundColor: "#DCF1F3"
            ...
            {(["google", "fb"] as const).map(t => <button key={t} onClick={() => setTab(t)} className="px-6 py-2 rounded-full text-sm font-semibold transition-all duration-200" style={{
            fontFamily: "'Plus Jakarta Sans', sans-serif",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {reviews.map((review, i) => <motion.div key={review.id} initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
        ...
        <div className="text-center mt-10 space-y-2">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a href="https://www.google.com/search?q=Casa+Primera+Hotspring+Resort+Calamba+reviews" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-2 rounded-full text-sm font-semibold transition-all hover:scale-105" style={{
            ...
            <a href="https://www.facebook.com/casaprimeravilla2020/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-2 rounded-full text-sm font-semibold transition-all hover:scale-105" style={{
