...
export function HowToBook() {
  return <section id="how-to-book" className="py-20 overflow-hidden" style={{
    background: "linear-gradient(180deg, #DCF1F3 0%, #EAF7F8 100%)"
  }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          ...
          color,
          bg
        }, i) => <motion.div key={number} initial={{
          opacity: 0,
          y: 25
        }} whileInView={{
          opacity: 1,
          ...
          delay: i * 0.1,
          duration: 0.5
        }} className="relative rounded-2xl p-6 shadow-sm" style={{
          backgroundColor: "#fff",
          border: "1px solid rgba(69,179,192,0.1)"
        }}>
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center" style={{
              backgroundColor: bg
            }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
          ...
          label: "Down Payment",
          value: "50%",
          note: "to secure reservation",
          color: "#45B3C0"
        }, {
          label: "Balance",
          value: "50%",
          note: "Payable Upon Arrival",
          color: "#333333"
        }, {
          label: "Security Deposit",
          value: "Php 2,000",
          note: "Refundable Upon Check-out (if no incidental expenses are incurred)",
          color: "#FFEB3B"
        }, {
          ...
          note,
          color
        }) => <div key={label} className="rounded-2xl p-4 text-center shadow-sm flex flex-col" style={{
          backgroundColor: "#fff"
        }}>
              <p style={{
            fontFamily: "'Fraunces', serif",
